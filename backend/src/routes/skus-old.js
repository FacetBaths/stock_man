...
// Validation middleware for the new SKU model
const validateSKU = [
  body('sku_code')
    .optional()
    .trim()
  ...
  body('dimensions.unit')
    .optional()
    .isIn(['inches', 'feet', 'centimeters', 'meters'])
    .withMessage('Dimension unit must be inches, feet, centimeters, or meters'),
  body('is_active')
    .optional()
    .isBoolean()
  ...
  body('bundle_items.*.sku_id')
    .optional()
    .isMongoId()
    .withMessage('Bundle item SKU ID must be a valid MongoDB ID'),
